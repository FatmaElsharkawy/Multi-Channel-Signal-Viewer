from numpy import arange, sin, pi, float16, size
...
class MyFrame(wxPython.Frame):
    def __init__(self, parent, id):
        wxPython.Frame.__init__(self,parent, id, 'scrollable plot',
                style=wxPyt.DEFAULT_FRAME_STYLE ^ wxPython.RESIZE_BORDER,
                size=(800, 400))
