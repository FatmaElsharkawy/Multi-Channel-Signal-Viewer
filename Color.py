...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.signals_info_table2.horizontalHeader().sectionClicked.connect(self.show_colors)

    
    def show_colors(self, column):
        if column == 2:  # Color column
            ...
            if color.isValid():
                ...
                self.signals_info_table2.setItem(row_count, column, QTableWidgetItem())  # Placeholder text
